...
(function($){
    $.fn.searchable = function(){
        return this.each(function(){
            ...
            $('<input type=\"search\" id=\"bsearch\" results=\"5\" placeholder=\"search bookmarks\" size=\"70\" class=\"curved\" />').insertBefore(targetTable).before('Search bookmarks: ').keyup(function(event){
